...
const Inscription = () => {
  return (
    ...
    <div className='flex flex-col justify-center items-center w-2/4'>
        ...
        <input className='w-full p-3 m-3 bg-stone-100'type="text" placeholder='Entrer votre nom' />
        <input className='w-full p-3 m-3 bg-stone-100' type="text" placeholder='Entrer votre prénom' />
        <input className='w-full p-3 m-3 bg-stone-100' type="text" placeholder='Entrer votre adresse mail' />
        <input className='w-full p-3 m-3 bg-stone-100' type="password" placeholder='Entrer votre mot de passe' />
...
active:border-b-[2px] active:brightness-90 active:translate-y-[2px] w-full text-xl">S'inscrire</button>
        </Link>
...
border-black
border-b-[4px] hover:brightness-110 hover:-translate-y-[1px] hover:border-b-[6px]
active:border-b-[2px] active:brightness-90 active:translate-y-[2px] w-full my-5 text-xl">Continuer avec Google <FaFingerprint className='mx-7' /></button>
        </Link>
    </div>
