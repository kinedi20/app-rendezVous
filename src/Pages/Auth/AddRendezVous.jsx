  ...
  return (
    <div className='flex'>
        ...
        <div className='flex flex-col  items-center w-2/4  py-20'>
           <img src={logo} alt="imageLogo"  className='w-44 bg-sky-300 rounded-full py-3'/>
        ...
        <div className="max-w-md mx-auto border-none rounded-lg">
              ...
              <Link to='/dashboard/mesrendezvous'><button className="cursor-pointer transition-all bg-blue-500 text-white px-6 py-2 rounded-lg
border-blue-600
